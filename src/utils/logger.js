...
const logWithMarker = (message, ...args) => {
  if (getLogLevel() > LOG_LEVEL.debug) {
    return;
  }
  log(MARKER);
...
const infoWithMarker = (message, ...args) => {
  if (getLogLevel() > LOG_LEVEL.info) {
    return;
  }
  info(MARKER);
...
const debugWithMarker = (message, ...args) => {
  if (getLogLevel() > LOG_LEVEL.debug) {
    return;
  }
  debug(MARKER);
...
const warnWithMarker = (message, ...args) => {
  if (getLogLevel() > LOG_LEVEL.warn) {
    return;
  }
  warn(MARKER);
...
const errorWithMarker = (message, ...args) => {
  if (getLogLevel() > LOG_LEVEL.error) {
    return;
  }
  error(MARKER);
