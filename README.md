...
```bash
{
  "name": "with-commonjs-eslint-jest",
  "version": "1.0.0",
  "description": "template project for express + nodejs + commonjs + eslint + jest",
  "main": "src/app.js",
  "scripts": {
...
```bash
npx degit "https://github.com/templates-deltacap019/with-commonjs-eslint-jest.git" "my_proj"
```
